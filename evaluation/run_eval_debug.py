...
from retrieval import setup_retriever, retrieve, setup_retriever_shards
...
def main():
    ...
    if "dpr" in args.prompt_mode:
        ...
        # )
        ds_with_embeddings, q_encoder, q_tokenizer = setup_retriever_shards(
            # shard_names = ["p3_subset_6_1","p3_subset_6_3-part-1","p3_subset_6_3-part-2"], 
            shard_names = ["p3_subset_6_3-part-2"], 
